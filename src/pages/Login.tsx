  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      <div className="max-w-md w-full bg-white p-8 rounded-lg shadow-md">
        ...
        <h2 className="text-center text-2xl font-bold text-gray-900">Selamat Datang</h2>
        <p className="text-center text-sm text-gray-600">Silakan masuk dengan akun Anda</p>
